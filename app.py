...
def get_ai_response(user_input):
    model = genai.GenerativeModel("gemini-1.5-pro")  # Update this if needed
...
with tab2:
    ...
    **Affiliation:** Guru Gobind Singh Indraprastha University, New Delhi
    ...
    st.write("Python, MongoDB, Django")
    ...
    with col1:
        st.markdown(
            '<a href="mailto:prashantchoudharys123@gmail.com" style="text-decoration: none;"><button style="background-color: #FF9900; color: white; border: none; padding: 10px; border-radius: 5px; width: 100%;">📧 Email</button></a>',
            unsafe_allow_html=True)
    with col2:
        st.markdown(
            '<a href="https://www.linkedin.com/in/prashant-kumar-62b76024a/" style="text-decoration: none;"><button style="background-color: #0077B5; color: white; border: none; padding: 10px; border-radius: 5px; width: 100%;">👔 LinkedIn</button></a>',
            unsafe_allow_html=True)
    with col3:
        st.markdown(
            '<a href="https://github.com/Prashant8008" style="text-decoration: none;"><button style="background-color: #333; color: white; border: none; padding: 10px; border-radius: 5px; width: 100%;">💻 GitHub</button></a>',
            unsafe_allow_html=True)

st.markdown("---")
st.markdown("© 2025 Solar Industry AI Assistant | Developed by Prashant Kumar")